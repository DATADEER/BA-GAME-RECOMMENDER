...
1. Es wird **Python 3.7** zur Ausführung des Codes benötigt.
...
1. Der **Jupyter Notebook Server** sollte nun von alleine die richtige Seite im Standard-Browser geöffnet haben. Wenn dem nicht so ist, sollte die benötigte URL bei Server Start in der Shell als 
...
* Das **ausführbare Script** befindet unter `/notebooks/get_game_recommendations.ipynb/`
